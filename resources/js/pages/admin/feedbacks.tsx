...
const Feedbacks: React.FC<Props> = ({
    feedbacks,
    stats,
    ratingDistribution,
}) => {
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-gray-400">
                                Notas e sugestões enviadas pelo app mobile
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-3">
                        {Object.entries(ratingDistribution).map(
                            ([rating, count]) => (
                                <div
                                    key={rating}
                                    className="grid grid-cols-[48px_1fr_40px] items-center gap-4"
                                >
                                    <span className="font-mono text-sm text-yellow-300">
                                        {rating} ★
                                    </span>
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-gray-700">
                                {feedbacks.data.map((feedback) => (
                                    <tr
                                        key={feedback.id}
                                        className="align-top transition-colors hover:bg-gray-700/30"
                                    >
